...
export default function Hero() {
  ...
  if (pathname === '/en') {
    lenguage = (
      <Link href="/es" className="text-sm font-semibold leading-6 text-white">
        Español
      </Link>
    )
  } else {
    lenguage = (
      <Link href="/en" className="text-sm font-semibold leading-6 text-white">
        English
      </Link>
    )
  }
      ...
      <div className="relative isolate pt-14">
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex flex-col lg:items-center 	">
          <div className="mx-auto max-w-5xl lg:mx-0 lg:flex-auto w-full flex flex-col items-center">
            ...
            <p className="  text-center text-white text-2xl mt-10 font-bold">
              {t('highlight')}
            </p>
          ...
          <div className="w-full flex  justify-center">
            <button
              type="button"
              onClick={openModal}
              className="mt-14  z-50 shadow-xl bg-gray-900 py-3   items-center gap-x-4 rounded-full flex flex-row active:bg-gray-900 hover:bg-gray-800  pl-6 pr-4  "
            >
              <p className="flex font-bold text-white">{t('cta')}</p>
