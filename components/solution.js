    ...
    <div id="solution" className="bg-white">
      <div className="mx-auto max-w-2xl px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-6 text-base leading-7 mb-5 text-gray-600">{t('subheadline')} </p>
                ...
                <div className="flex flex-row mt-10 ">
                  <dl className="  text-gray-900 ">
                    ...
                    <dt className="text-sm leading-6">{t('features.handheld.stat-1-description')} </dt>
                      <dd className="order-first text-3xl font-semibold tracking-tight">{t('features.handheld.stat-1')}</dd>
                    </div>
                  </dl>
                  <dl className="ml-10 text-gray-900 ">
                    <div className="flex flex-col gap-y-3 border-l border-gray-900 pl-6">
                    <dt className="text-sm leading-6">{t('features.handheld.stat-2-description')} </dt>
                      <dd className="order-first text-3xl font-semibold tracking-tight">{t('features.handheld.stat-2')}</dd>
                    </div>
                  </dl>
                </div>
              </div>
