            ...
            <div className="flex bg-slate-200 rounded-2xl lg:p-8  p-5 pb-10 lg:pb-0 lg:flex-row flex-col lg:items-center lg:gap-x-24 ">
              ...
              <div className="flex flex-col max-w-3xl">
                <div className="flex flex-col">
                  <div className="flex flex-col ">
                    <h3 className="text-3xl flex font-bold text-indigo-600"> {t('features.tag.name')} </h3>
                  </div>
                ...
                <div className="flex flex-row mt-10 ">
                  <dl className="  text-gray-900 ">
                    <div className="flex flex-col  lg:items-center gap-y-3 ">
                      ...
                      <dt className="text-sm leading-6 text-indigo-600 font-bold ">{t('videocta')} </dt>
                    </div>
                  </dl>
                  <dl className=" lg:ml-10 ml-5 text-gray-900 ">
                    <div className="flex flex-col gap-y-3 border-l border-gray-900 pl-6">
                      <dt className="text-sm leading-6">{t('features.tag.stat-1-description')} </dt>
                      <dd className="order-first text-3xl font-semibold tracking-tight">{t('features.tag.stat-1')}</dd>
                    </div>
                  </dl>
                  <dl className="lg:ml-10 ml-5 text-gray-900 ">
                    <div className="flex flex-col gap-y-3 border-l border-gray-900 pl-6">
                      <dt className="text-sm leading-6">{t('features.tag.stat-2-description')} </dt>
                      <dd className="order-first text-3xl font-semibold tracking-tight">{t('features.tag.stat-2')}</dd>
                    </div>
                  </dl>
                </div>
              </div>
